...
// Schema IDs
const (
	MaturityModelSchemaID = "https://github.com/grokify/prism-maturity/schema/prism-maturity-model.schema.json"
	MaturityStateSchemaID = "https://github.com/grokify/prism-maturity/schema/prism-maturity-state.schema.json"
	MaturityPlanSchemaID  = "https://github.com/grokify/prism-maturity/schema/prism-maturity-plan.schema.json"
)
